...
namespace DywFunctions {
    namespace DataHandle {
        ...
        {
            public static void JSONSaveData(T data, string fileName) {
            ...
            public static T JSONLoadData(string fileName) {
            ...
            public static void BINSaveData(T objectToSave, string fileName) {
                try {
            ...
            public static T BINLoadData(string fileName) {
